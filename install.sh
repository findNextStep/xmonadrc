...
apt install arandr feh hsetroot xcompmgr shutter indicator-cpufreq autocutsel numlockx happy alex gtk2hs-buildtools icdiff xmonad taffybar google-chrome-stable code xmonad cabal-install feh taffybar hsetroot xcompmgr numlockx libgtk-3-dev indicator-cpufreq suckless-tools sakura gobject-introspection libgirepository1.0-dev libdbusmenu-gtk3-dev libgirepository1.0-dev libwebkit2gtk-4.0-dev libgtksourceview-3.0-dev python-smbus -y
